...
left_column, middle_column, right_column = st.columns([1, 0.8, 0.8], gap='large')


# Left Column: Title, Introduction, and Equations
with left_column:
    # Streamlit UI
...
# Middle Column: Input parameters (boxes and sliders)
with middle_column:
    ...
    # Use the middle column to place your element, effectively centering it
    with col2:
...
with right_column:
    ...
    farmers_chart = alt.Chart(all_farmers_data_melted).mark_line(point=True).encode(
        ...
        width=700,
        height=400,
        title="Full-Time Farmers vs. Farm Size"
    )
